...
def save_epoch_result_mask(folder, epoch, x_img_private, mask_private, inter_private, gen_img_private, y_img_private, x_img_public, mask_public, inter_public, gen_img_public, y_img_public):
    num_images = 2
