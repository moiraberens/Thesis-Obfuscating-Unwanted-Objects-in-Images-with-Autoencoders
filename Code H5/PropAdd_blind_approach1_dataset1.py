...
if __name__ is "__main__":
    ...
    for setting in obf_weights:
        ...
        for number in range(3):
            ...
            folder = 'results/propAdd_blind_approach1_dataset1/weight_{}_number_{}'.format(settings['loss_weight_obf'], number)
            ...
            for epoch in tqdm(range(settings['epochs'])):
                ...
                io_utils.save_epoch_result(folder, epoch, x_batch_private, mask_private, inter_private, gen_private_images, y_batch_image_private, x_batch_public, mask_public, inter_public, gen_public_images, x_batch_public)
