...
if __name__ is "__main__":
    ...
    for setting in obf_weights:
        ...
        for number in range(3):
            ...
            folder = 'results/propAdd_blind_approach1_dataset2/weight_{}_number_{}'.format(settings['loss_weight_obf'], number)
            ...
            #comb.compile(optimizer=Adam(lr=settings['learning_rate_att']), loss = ['mean_squared_error', 'mse', 'mse'], loss_weights=[obf_loss_weight, att_loss_weight, att_loss_weight], metrics = ['mae'])
