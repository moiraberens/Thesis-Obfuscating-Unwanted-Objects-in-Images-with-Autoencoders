...
# =============================================================================
#     image = ((x_train_private[45]+1)*127.5).astype(np.uint8)
#     sub_face = imageio.imread('face.png')
#     sub_image = image[10:20,10:20,:]
#     sub_blend = np.array(Image.blend(Image.fromarray(sub_image),Image.fromarray(sub_face),0.67))
#     
#     image_blend = np.copy(image)    
#     image_blend[10:20,10:20,:] = sub_blend
#     plt.figure(1)
#     plt.clf()
#     plt.imshow(image_blend)
#     
#     image_raw = np.copy(image)
#     image_raw[10:20,10:20,:] = sub_face
#     plt.figure(2)
#     plt.clf()
...
if __name__ is "__main__":
    ...
    num_models = len(batchnorm) * len(same_batch) * len(depth) * len(initial_filters) * len(extra_block) 
